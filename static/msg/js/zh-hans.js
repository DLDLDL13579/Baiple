...
Blockly.Msg["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "循环直到条件满足";
Blockly.Msg["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "当条件满足时循环";
...
Blockly.Msg["LISTS_REPEAT_TITLE"] = "建立列表使用项 %1 循环 %2 次";
Blockly.Msg["LISTS_REPEAT_TOOLTIP"] = "建立包含指定循环次数的值的列表。";
...
Blockly.Msg["PROCEDURES_CALL_BEFORE_PARAMS"] = "参数值：";
Blockly.Msg["PROCEDURES_CREATE_DO"] = "调用函数“%1”";
Blockly.Msg["PROCEDURES_DEFNORETURN_COMMENT"] = "描述该函数功能...";
Blockly.Msg["PROCEDURES_DEFNORETURN_DO"] = "申明语句：";
...
Blockly.Msg["PROCEDURES_DEFRETURN_TOOLTIP"] = "定义一个有输出值的函数。";
...
Blockly.Msg["PROCEDURES_MUTATORARG_TITLE"] = "输入参数名称：";
Blockly.Msg["PROCEDURES_MUTATORARG_TOOLTIP"] = "添加函数输入参数。";
Blockly.Msg["PROCEDURES_MUTATORCONTAINER_TITLE"] = "输入参数";
Blockly.Msg["PROCEDURES_MUTATORCONTAINER_TOOLTIP"] = "添加、移除或重新排此函数的输入。";
Blockly.Msg["OBJECTS_DEF_TOOLTIP"] = "在对象名处可以更改对象名，在参数名(或方法名)处更改none为具体的参数名(或方法名)才会自动生成对象代码。";
Blockly.Msg["REDO"] = "重做";
